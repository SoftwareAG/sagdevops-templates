...
# Starting EntireX RPC Server for Java and sending it into the background.
$JAVA_HOME/bin/java -classpath "$EXXDIR/classes/entirex.jar:/data:$EXXDIR/../common/lib/saglic.jar:$EXX_JAVA_SERVER_CLASSPATH" "-Dentirex.server.properties=/configs/$EXX_JAVA_SERVER_CONFIGURATION" "-Dentirex.license.location=$EXXDIR/config/license.xml" com.softwareag.entirex.aci.RPCServer $* &
