...
This template demonstrates in detail how to install the EntireX Core component, creates and configures an RPC Server for IMS. Use this template as a reference when provisioning EntireX RPC Server for IMS instances.
...
* Creating an EntireX RPC Server for IMS
* Configuration of:
  * License
...
To provision an instance of an EntireX RPC Server for IMS, use the Command Central CLI with the following command:

```
sagcc exec templates composite apply sag-exx-ims-rpc-server nodes=<your_node> \
