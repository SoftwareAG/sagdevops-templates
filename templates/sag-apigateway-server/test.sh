...
if [ -d $SAG_HOME/profiles/SPM ] ; then
    ...
    export __is_instance_name=${__is_instance_name:-apigateway}
    ...
    sagcc get configuration data "OSGI-IS_${__is_instance_name}" COMMON-JVM-OPTIONS -f text -e gc_agw.log
