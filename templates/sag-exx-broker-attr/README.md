...
This template demonstrates in detail how to install the EntireX Broker component and creating a new Broker instance with specifying a complete attribute file in the template.
